(function () {
  ...
  var I18N = {
    en: {
      ...
      pr_eye: 'Proof', pr_t: 'Built from real systems.',
      pr_p: 'Real-time graphics, sensing and projection already delivered by ANDATA.',
      pr_del: 'Delivered',
      pr1_loc: 'Mexico City', pr2_loc: 'Aguascalientes', pr3_loc: 'Jalisco',
      pr1: 'Presence, not identity — the architecture Portrait of Place would use.',
      pr2: 'Motion-tracked rooms for general audiences.',
    ...
    es: {
      ...
      pr_eye: 'Prueba', pr_t: 'Construido con sistemas reales.',
      pr_p: 'Gráficos en tiempo real, sensado y proyección que ANDATA ya entregó.',
      pr_del: 'Realizado',
      pr1_loc: 'Ciudad de México', pr2_loc: 'Aguascalientes', pr3_loc: 'Jalisco',
      pr1: 'Presencia, no identidad — la arquitectura que usaría Portrait of Place.',
      pr2: 'Salas con seguimiento de movimiento para públicos generales.',
